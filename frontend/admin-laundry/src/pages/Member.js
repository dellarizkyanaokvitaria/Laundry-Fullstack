...
//note : jika menggunakan bootstrap 4 tidak usah menambahkan script diatas
...
export default class Home extends React.Component{
    constructor(){
        super()
        // siapkan state --> untuk pembuat halaman customer
        this.state = {
            member:[],
            token: "",
            action: "",
        ...
        /* 
        logika if-else --> untuk mengecek apakah user yg mengakses telah melakukan login sebagai admin atau belum
        */
                    ...
                    <div className="modal-content">
                        ...
                        <form onSubmit={ev => this.saveMember(ev)}>
                                    ...
                                    <div className="form-group">
                                        <select name="jenis_kelamin" id_jenis="jenis_kelamin" className="form-control"
